...
import { getJobs, getCompetencies, getProficiencyLevels, addJobRequirement, updateJobRequirement, deleteJobRequirement, type Job as ServiceJob, type Competency as ServiceCompetency } from '../../../api/services';
